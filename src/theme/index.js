export default {
	...
	"fontFamily": {
		...
		"googleStintUltraExpanded": "\"Stint Ultra Expanded\", cursive",
		"googleMontserrat": "\"Montserrat\", sans-serif"
	},
	"font": {
		"headline1": "normal 900 192px/1.2 --fontFamily-googleArbutusSlab",
		"headline2": "normal 900 42px/1.2 --fontFamily-sans",
		"headline3": "normal 500 28px/1.2 --fontFamily-sans",
		"base": "normal 500 12px/1.5 --fontFamily-googleMontserrat",
